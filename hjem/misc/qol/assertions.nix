{
  ...
  assertions = [
    {
      assertion = !config.rum.desktops.hyprland.enable || osConfig.dotfiles.desktop.enable;
      message = "rum.desktops.hyprland.enable requires dotfiles.desktop.enable = true on this host.";
    }
    {
      assertion = !config.dotfiles.desktop.zed.enable || osConfig.dotfiles.desktop.enable;
      message = "dotfiles.desktop.zed.enable requires dotfiles.desktop.enable = true on this host.";
    }
    {
      assertion = !config.rum.programs.mpv.enable || osConfig.dotfiles.desktop.enable;
      message = "rum.programs.mpv.enable requires dotfiles.desktop.enable = true on this host.";
    }
    {
      assertion = !config.rum.programs.obs-studio.enable || osConfig.dotfiles.desktop.enable;
