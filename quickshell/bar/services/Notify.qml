...
Singleton {
    ...
    property bool trackLowUrgency: Settings.notifyTrackLowUrgency
    property real timeoutLow: Settings.notifyTimeoutLow
    property real timeoutNormal: Settings.notifyTimeoutNormal
    property real timeoutCritical: Settings.notifyTimeoutCritical
    property int maxPopups: Settings.notifyMaxPopups
    property int maxCenterItems: Settings.notifyMaxCenterItems
